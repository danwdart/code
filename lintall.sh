...
#! nix-shell -p haskell.packages.ghc98.stylish-haskell haskell.packages.ghc98.hlint haskell.packages.ghc98.apply-refact haskell.packages.ghc910.cabal-fmt parallel -i bash
set -euo pipefail
mkdir -p ~/.parallel
