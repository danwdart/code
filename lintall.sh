...
#! nix-shell -I nixpkgs=https://github.com/NixOS/nixpkgs/archive/haskell-updates.tar.gz -p haskell.packages.ghc942.stylish-haskell haskell.packages.ghc942.hlint haskell.packages.ghc902.apply-refact parallel -i bash
set -e
